...
curve(dbeta(x, shape1=1,shape2=2), xlim=c(0,1), ylim=c(0,1.5), lwd=2, ylab="Beta Density", main="Shape1=1,Shape2=2")
curve(dbeta(x, shape1=3,shape2=1), xlim=c(0,1), ylim=c(0,5), lwd=2, ylab="Beta Density", main="Shape1=3,Shape2=1")
curve(dbeta(x, shape1=5,shape2=1), xlim=c(0,1), ylim=c(0,5), lwd=2, ylab="Beta Density", main="Shape1=5,Shape2=1")
curve(dbeta(x, shape1=3,shape2=4), xlim=c(0,1), ylim=c(0,3), lwd=2, ylab="Beta Density", main="Shape1=3,Shape2=4")

par(mfrow=c(1,1))

curve(dbeta(x, shape1=3,shape2=2), xlim=c(0,1), ylim=c(0,3), lwd=2, ylab="Beta Density", main="Shape1=3, Shape2=2")
...
curve(dbeta(x, shape1=6,shape2=3), xlim=c(0,1), ylim=c(0,3), lwd=2, ylab="Beta Density", main="Shape1=6, Shape2=3")
...
curve(dbeta(x, shape1=2,shape2=4), xlim=c(0,1), ylim=c(0,3), lwd=2, ylab="Beta Density", main="Shape1=2, Shape2=4")
