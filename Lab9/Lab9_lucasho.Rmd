...
There are duplicates in the sample
...
An occurs because you it is not possible to take sample without replacement with a size larger than the population
...
For the norm, 23.88 is close to the population mean of 25

For chisq, the point estimate 2.94 is close the population mean of 3

For gamma, the point estimate 6.5 is close the the mean of  \[\alpha\beta=3(2)=6\]

For beta, the point estimate 0.41 is close to the mean of \[\frac{\alpha}{\alpha + \beta} = \frac{3}{3 + 4}=0.429\]
...
stat=myboot2(10000, x=sam, fun="median", alpha=0.05, xlab="median",col="Purple",cx=1.5)
```
